...
/** A single exchange in the advisor conversation, oldest first. */
...
export interface AdvisorReply {
  ...
  /** Inline explanations for terms in suggestedActions. */
  suggestedActionAnnotations: AdvisorOutput["suggestedActionAnnotations"]
}
...
export class Engine {
  ...
  /**
   * Consults the advisor: the player's strategic counsel. Builds the advice
  ...
  async consultAdvisor(
    ...
    return Result.ok({
      ...
      suggestedActionAnnotations: parsed.value.suggestedActionAnnotations,
    })
  }
