...
/**
 * What the advisor (the player's strategic counsel) returns: prose advice
...
export const AdvisorOutputSchema = z.strictObject({
  ...
  /**
   * Optional inline explanations for terms inside suggestedActions. Each term
   * must be an exact substring of the referenced suggested action.
   */
  suggestedActionAnnotations: z
    .array(
      z.strictObject({
