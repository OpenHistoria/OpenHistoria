...
/**
 * Local provider override for the adventure engine.
 *
 * By default Open Odyssey drives the story through OpenRouter with the player's
 ...
 * taking precedence):
 *
 *   base URL  NEXT_PUBLIC_LLM_BASE_URL  / localStorage "openodyssey:llm-base-url"
 *   api key   NEXT_PUBLIC_LLM_API_KEY   / localStorage "openodyssey:llm-api-key"
 *   model     NEXT_PUBLIC_LLM_MODEL     / localStorage "openodyssey:llm-model"
 */

export const LLM_BASE_URL_STORAGE_KEY = "openodyssey:llm-base-url"
export const LLM_API_KEY_STORAGE_KEY = "openodyssey:llm-api-key"
export const LLM_MODEL_STORAGE_KEY = "openodyssey:llm-model"
...
/** Model id new adventures default to when a local provider is configured. */
