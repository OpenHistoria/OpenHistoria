...
export interface Messages {
  ...
  newGame: {
    ...
    modelOpenRouterFree: string
    modelOpenRouterFreeHint: string
    modelFree: string
  ...
  game: {
    ...
    directivesOutcomeFallback: string
...
const en: Messages = {
  ...
  newGame: {
    ...
    modelOpenRouterFree: "OpenRouter free auto-router",
    modelOpenRouterFreeHint:
      "Lets OpenRouter pick and fall back among free models for you, server-side.",
    modelFree: "Free",
    modelPrice: (input, output) => `$${input} in · $${output} out / 1M tokens`,
  },
  openrouter: {
  ...
  game: {
    ...
    economyTitle: "Economy pulse",
    economyEmpty: "Awaiting data",
    economyMetrics: {
      market: "Markets",
      stability: "Stability",
      supply: "Supply",
    ...
    advisor: {
      ...
      added: "Added",
      error: "Your advisor could not respond.",
      retry: "Try again",
      you: "You",
    ...
    directivesHint:
      "These orders steer your nation on the next jump forward. Add as many as you like.",
    ...
    directivesOutcomeFallback: "No concrete outcome was recorded this turn.",
    ...
    errors: {
      ...
      invalidOutput: "The AI returned an unexpected response.",
      network:
      ...
      storage: "The game state could not be saved.",
      generic: "Something went wrong advancing the year.",
    },
  },
  menu: {
    open: "Menu",
...
const fr: Messages = {
  ...
  newGame: {
    ...
    modelOpenRouterFree: "Routeur gratuit OpenRouter",
    modelOpenRouterFreeHint:
      "Laisse OpenRouter choisir et alterner les modèles gratuits pour vous, côté serveur.",
    modelFree: "Gratuit",
  ...
  game: {
    ...
    economyTitle: "Pouls économique",
    economyEmpty: "Données en attente",
    economyMetrics: {
      market: "Marchés",
      stability: "Stabilité",
    ...
    jumpHint:
      "Le temps est figé jusqu'à ce que vous l'avanciez. Choisissez la durée du saut.",
    jumpWeek: "1 semaine",
    jumpMonth: "1 mois",
    jump3Months: "3 mois",
    jump6Months: "6 mois",
    ...
    advisor: {
      ...
      added: "Ajoutée",
      error: "Votre conseiller n'a pas pu répondre.",
      retry: "Réessayer",
      you: "Vous",
    ...
    directivesTitle: "Directives",
    directivesHint:
      "Ces ordres orientent votre nation au prochain saut dans le temps. Ajoutez-en autant que vous voulez.",
    ...
    directivesOutcomeFallback:
      "Aucun résultat concret n'a été enregistré ce tour-ci.",
    ...
    errors: {
      ...
      invalidOutput: "L'IA a renvoyé une réponse inattendue.",
      network:
        "Impossible de joindre OpenRouter. Vérifiez votre connexion.",
      requestFailed: (status, message) =>
        message
      ...
      empty: "L'IA a renvoyé une réponse vide.",
      storage: "L'état de la partie n'a pas pu être enregistré.",
      generic: "Une erreur est survenue en avançant dans le temps.",
    },
  },
  menu: {
    open: "Menu",
    ...
    exitConfirm: "Quitter cette partie",
    cancel: "Annuler",
