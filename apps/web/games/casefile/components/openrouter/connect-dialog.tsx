...
import { useOpenRouter } from "@/games/casefile/hooks/use-openrouter"
import { formatOpenRouterError } from "@/games/casefile/lib/errors"
import { OPENROUTER_DASHBOARD_URL, beginOpenRouterAuth } from "@/games/casefile/lib/openrouter"
import { OpenRouterLogo } from "@/games/casefile/components/openrouter/openrouter-logo"

const STEPS = [
  {
    title: "Authorize Open Case",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" closeLabel="Close">
        ...
        <DialogDescription>
          {status === "connected"
            ? "Your cases are powered by your own OpenRouter account."
            : "Open Case runs on your own model. Connect OpenRouter to begin."}
        </DialogDescription>
          ...
          <div className="grid gap-3">
            ...
            {keyInfo?.isFreeTier && (
              <p className="text-xs text-muted-foreground">
                You&apos;re on the free tier. Free models work great for cases.
              </p>
            )}
