...
import { formatOpenRouterError } from "@/games/odyssey/lib/errors"
import { OPENROUTER_DASHBOARD_URL, beginOpenRouterAuth } from "@/games/odyssey/lib/openrouter"
import { OpenRouterLogo } from "@/games/odyssey/components/openrouter/openrouter-logo"

const STEPS = [
  {
    title: "Authorize Open Odyssey",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" closeLabel="Close">
        ...
        <DialogDescription>
          {status === "connected"
            ? "Your adventures are powered by your own OpenRouter account."
            : "Open Odyssey runs on your own model. Connect OpenRouter to begin."}
        </DialogDescription>
            ...
            <div className="flex items-center justify-between rounded-lg border bg-muted/40 px-3 py-2.5">
              <div className="grid gap-0.5">
                <span className="font-medium">
                  {keyInfo?.label || "Open Odyssey key"}
                </span>
