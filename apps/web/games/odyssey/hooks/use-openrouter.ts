...
} from "@/games/odyssey/lib/openrouter"
...
/**
 * Tracks whether this browser holds an OpenRouter key and validates it against
 * the API. A revoked key is cleared automatically so the UI falls back to the
 * connect prompt instead of failing later mid-story.
 */
